...
export function AttendanceListPage(props: AttendanceListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      header: 'Time In',
      accessorKey: 'time_in',
      cell: ({ row: { original: record } }: any) => (record?.time_in ? format(record?.time_in, 'dd-MM-yyyy') : ''),
    },
    {
      id: 'time_out',
      header: 'Time Out',
      accessorKey: 'time_out',
      cell: ({ row: { original: record } }: any) => (record?.time_out ? format(record?.time_out, 'dd-MM-yyyy') : ''),
    },
