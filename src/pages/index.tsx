  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application - Streamlining Your Human Resources Processes for Optimum Business Efficiency and Productivity"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application - Streamlining Your Human Resources Processes for Optimum Business Efficiency and Productivity`}
            </Text>
            <Box
